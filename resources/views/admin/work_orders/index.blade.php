                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-1">
                                        ...
                                        @else
                                            ...
                                            <x-icon-btn :href="route('admin.work_orders.pdf', $order)" color="gray" label="Generar PDF" target="_blank">
                                            ...
                                            @can('update work_orders')
                                                <x-icon-btn :href="route('admin.work_orders.edit', $order)" color="brand" label="Editar">
